...
// A fetch to Backpack CMS triggered by a user asking something from chatgpt bot
// bot will need a prompt to direct it on under what conditions it should consider doing the fetch to cms
